"""Windmill entrypoint for read-only CCGS Story checks."""
...
def _adapter(framework_root: str):
    ...
    return run_story_check, raise_for_windmill, WindmillAdapterError
...
def main(
    ...
    run_story_check, raise_for_windmill, adapter_error = _adapter(framework_root)
    try:
